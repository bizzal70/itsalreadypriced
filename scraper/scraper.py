"""
Daily scraper — pulls RSS/Atom feeds and stores new articles to SQLite.
Generic; sources live in feeds.py. Run: python scraper.py
"""
...
def main():
    ...
    for feed in FEEDS:
        ...
        print(f"    +{new} new from {feed['name']}")
        total_new += new
    conn.close()
